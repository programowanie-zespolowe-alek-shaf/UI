...
import bookInputs from "../pages/book/inputs/bookInputs";
...
const adminPanelUserDetailsSlice = createSlice({
  name: 'user',
  initialState,
  reducers: {
...
export const {reducer, actions} = adminPanelUserDetailsSlice;
const {
  fetchUser,
  fetchUserSuccess,
  fetchUserError
