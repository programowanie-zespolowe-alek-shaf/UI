  ...
  return (
    <React.Fragment>
      <ConfirmationModal
        ...
        aggreeText={'Usuń'}
        cancelText={'Anuluj'}
        aggreeCallback={() => deleteBook(deletedCategoryId)}
      />
      <Categories items={items} onBookDelete={onBookDelete} />
    </React.Fragment>
  );
};
